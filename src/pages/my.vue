<template>
  <div class="container hasnav">
    ...
    <div class="cen">
      ...
      <div class="cenlist">
        <yd-cell-group>
<!--           <yd-cell-item arrow type="link" href="/pointMarket">
            <span slot="left">成为分销商</span>
          </yd-cell-item> -->
          ...
          <yd-cell-item arrow type="link" href="/myLeader">
            <span slot="left">{{isLabel==1?'我的推荐人':'绑定推荐人'}}</span>
          </yd-cell-item>
          <yd-cell-item arrow type="link" href="/historyCommission">
